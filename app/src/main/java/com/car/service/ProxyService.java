...
import com.car.common.constants.Constants;
import com.car.common.utils.PermissionUtils;
import com.car.common.utils.PreferenceUtils;
import com.car.naive.connection.TestConnection;
import com.car.exempt.data.ExemptAppDataManager;
import com.car.exempt.data.ExemptAppDataSource;
 ...
 * {@link com.car.naive.connection.TrojanConnection}. For further information, see
 * {@link com.car.naive.connection.TrojanConnection}.
 */
public class ProxyService extends VpnService implements TestConnection.OnResultListener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        LogHelper.i("Naive", "Naive port is " + trojanPort);
        Log.e("Naive", "Naive port is " + trojanPort);

       NaiveHelper.ChangeListenPort(Globals.getNaiveConfigPath(), trojanPort);
       NaiveHelper.ShowConfig(Globals.getNaiveConfigPath());

        JNIHelper.RunNaive(getApplicationContext(),Globals.getNaiveConfigPath());//(Globals.getNaiveConfigPath());//trojan(Globals.getTrojanConfigPath());
        ...
        if (enable_clash) {
            try {
                ...
                LogHelper.i("Proxy", "clash port is " + clashSocksPort);
        ...
        LogHelper.i("Proxy", "tun2socks port is " + tun2socksPort);
        Log.e("Proxy", "tun2socks port is " + tun2socksPort);
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, channelId)
                .setSmallIcon(R.mipmap.icon)
                .setContentTitle("AndrProxy Active")
